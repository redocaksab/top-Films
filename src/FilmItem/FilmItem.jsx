    ...
    return (
        <>
            <div className={styles.filmInf}>
                {props.filmInfo.poster_path && <div className={styles.imageWrapper}><img alt="film poster" className={styles.filmPoster} src={`https://image.tmdb.org/t/p/original${props.filmInfo.poster_path}`} /></div>}
